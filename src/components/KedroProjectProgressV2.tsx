...
const KedroProjectProgressV2 = ({ isGenerating, projectName, onClose }: KedroProjectProgressProps) => {
  ...
  return (
    <div className="kedro-progress-card w-[450px] rounded-lg border p-6 shadow-lg">
      <div className="mb-6">
        <h3 className="kedro-progress-title text-lg mb-1">Creating Kedro Project</h3>
        <p className="kedro-progress-description text-sm">
      ...
      <div className="space-y-6">
        <div>
          ...
          <div className="kedro-progress-bar w-full overflow-hidden rounded-full bg-gray-700">
            <div 
              className="kedro-progress-indicator h-full transition-all"
          ...
          {steps.map((step, index) => (
            <div key={index} className="flex items-center gap-3">
              ...
              <div className="flex-1">
                <p className={`kedro-progress-step text-sm ${currentStep === index ? 'font-medium' : ''}`}>
                  {step.name}
                </p>
                {step.message && (
...
export default KedroProjectProgressV2; 